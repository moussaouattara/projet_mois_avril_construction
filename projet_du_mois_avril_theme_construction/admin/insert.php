...
<html>
    ...
    <body style="background-image: url('https://mdbootstrap.com/img/Photos/Others/architecture.jpg');background-attachment: fixed;background-repeat:  no-repeat;background-size:  cover;font-family: Roboto, serif;">
        ...
        <div>
         ...
         <div class="container admin" style="padding-top: 5em;">
            <div class="row">
                <h1><strong>Ajouter un terrain</strong></h1>
                <br>
                <form class="form" action="insert.php" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="description">Description du terrain:</label>
                        <input type="text" class="form-control" id="description" name="description" placeholder="Description" value="<?php echo $description;?>">
                        <span class="help-inline"><?php echo $descriptionError;?></span>
                    </div>
                    <div class="form-group">
                        <label for="price">Prix du terrain: (en CFA)</label>
